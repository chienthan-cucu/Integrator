...
###
### Stage: RTL Synthesis
### File description: RTL Synthesis for best case
###
### Work Directory: ../RTL_Compiler
### Run command: RTL_Compiler ../Scripts/integrator_syn_min.tcl

## Setup technology files
include ../Scripts/XFAB_fast.tcl
...
report timing > ../Reports/Synth_timing_report_min
report area > ../Reports/Synth_area_report_min

# Write out netlist
write_hdl -mapped > ../Outputs/Synthesis/Synth_min.v

# Write out SDC file
write_sdc > ../Outputs/Synthesis/Syn_out_min.sdc
